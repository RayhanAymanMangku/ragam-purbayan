        ...
        <div className="flex-col gap-6">
            ...
            />
             <MainContent
                ...
                otherInfo="Program Masjos KKN UII Yogyakarta angkatan 71 membuat program pemberdayaan masyarakat terkait olah sampah dalam bentuk gim dan informasi dalam bentuk website. https://imujiel.github.io/masjos-web/"
                references="https://purbayankel.jogjakota.go.id/"
            />
        </div>
    )
}
